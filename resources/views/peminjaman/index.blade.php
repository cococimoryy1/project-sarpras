                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="jumlah_barang" class="form-control" min="1" max="{{ $barang->jumlah_tersedia }}" required>
                                            </div>
                                            <div class="form-group">
        ...
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Aksi untuk menyetujui atau menolak peminjaman -->
                        <form action="{{ route('peminjaman.approve', $peminjaman->peminjaman_id) }}" method="POST">
                            @csrf
